...
class client(models.Model):
    client_code = models.BigIntegerField(validators=[MaxValueValidator(9999999999)])
...
class products(models.Model):
    product_code = models.BigIntegerField(validators=[MaxValueValidator(9999999999)])
...
class order(models.Model):
    order_code = models.BigIntegerField(validators=[MaxValueValidator(9999999999)])
